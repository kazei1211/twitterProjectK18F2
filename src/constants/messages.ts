export const USERS_MESSAGE = {
  ...
  UNFOLLOWED: 'Un-followed',
  UNFOLLOW_SUCCESS: 'Un-follow successfully',
  ALREADY_UNFOLLOWED: 'This user is already unfollowed',
  USERNAME_ALREADY_EXISTS: 'User name already exists',
  USERNAME_IS_INVALID: 'Invalid user name',
  ...
  OLD_PASSWORD_IS_THE_SAME_AS_NEW_PASSWORD: 'Old password is the same as new password',
  REFRESH_SUCCESS: 'Refresh successfully',
  OAUTH_SUCCESS: 'Oauth login successfully',
...
export const TWEETS_MESSAGES = {
  ...
  TWEET_CREATED_SUCCESSFULLY: 'Tweet created succesfully'
}
